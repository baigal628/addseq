...
python /private/groups/brookslab/gabai/projects/Add-seq/scripts/makeArrow.py -b /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/EMW1.bam -e /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/eventalign/EMW1.eventalign.txt -o /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/arrow/full_EMW1.arrow
