...
python /private/groups/brookslab/gabai/projects/Add-seq/scripts/makeArrow.py -b /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/AUA1.bam -e /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/eventalign/AUA1.eventalign.txt -o /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/arrow/full_AUA1.arrow
