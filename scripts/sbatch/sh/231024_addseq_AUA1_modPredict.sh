#!/bin/bash
#SBATCH --job-name=AUA1ModPredict
#SBATCH --ntasks=1
...
python3 /private/groups/brookslab/gabai/projects/Add-seq/scripts/sbatch/py/231024_AUA1_mean_median_chrom.py

python3 /private/groups/brookslab/gabai/projects/Add-seq/scripts/sbatch/py/231024_AUA1_mean_median_neg.py

python3 /private/groups/brookslab/gabai/projects/Add-seq/scripts/sbatch/py/231024_AUA1_mean_median_pos.py
