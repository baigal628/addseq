...
python /private/groups/brookslab/gabai/projects/Add-seq/scripts/makeArrow.py -b /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/PHO3.bam -e /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/eventalign/PHO3.eventalign.txt -o /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/arrow/full_PHO3.arrow
