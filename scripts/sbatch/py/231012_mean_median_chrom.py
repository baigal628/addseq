...
modPredict(bam = chrom_bam, event = chrom_evt, region = 'PHO5', genome = genome,
           sigAlign = chrom_sigAlign,
           prefix = '231012_PHO5_chrom_meanScore_medianPos', n_rname=3, 
           outPath='/private/groups/brookslab/gabai/projects/Add-seq/data/chrom/predictMod/')