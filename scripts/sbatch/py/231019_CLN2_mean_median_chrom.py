...
sigAlign = '/private/groups/brookslab/gabai/projects/Add-seq/data/chrom/modPredict/231019_CLN2_chrom_meanScore_medianPos_chrXVI:66000-67550siganlAlign.tsv'

modPredict(bam = chrom_bam, event = chrom_evt, region = 'CLN2', 
           genome = genome, method = 'median', sigAlign = sigAlign,
           prefix = '231019_CLN2_chrom_meanScore_medianPos',
