...
neg_sigAlign = '/private/groups/brookslab/gabai/projects/Add-seq/data/ctrl/modPredict/231014_PHO5_neg_meanScore_medianPos_chrII:429000-435000siganlAlign.tsv'


modPredict(bam = neg_bam, event = neg_evt, region = 'PHO5', 
           genome = genome, method = 'mean', sigAlign = neg_sigAlign,
           prefix = '231014_PHO5_neg_meanScore_meanPos',
