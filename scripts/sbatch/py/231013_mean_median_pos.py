...
pos_sigAlign = '/private/groups/brookslab/gabai/projects/Add-seq/data/ctrl/eventalign/231012_PHO5_pos_chrII:429000-435000siganlAlign.tsv'

modPredict(bam = pos_bam, event = pos_evt, region = 'PHO5', 
           genome = genome, sigAlign = pos_sigAlign, method = 'median',
           prefix = '231013_PHO5_pos_meanScore_medianPos')